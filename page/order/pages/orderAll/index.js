...
const methods = {
    ...
    getOrderDataList({
        ...
        return ApiService.getOrderDataList({
            type,
            p
        }).finally(res => {
    ...
    getRefundData({
        ...
        return ApiService.getRefundData({
            p
        }).finally(res => {
    ...
    gotoPay(e) {
        ...
        let shop_id = e.currentTarget.dataset.item.shop_id;
        this.$route.push({
    ...
    gotoBillDetail(e) {
        console.log(e, 4444444444444444444);
