...
const appPage = {
    ...
    onShareAppMessage: function () {
        return {
            title: '分享有礼',
            path: `/page/activity/pages/wallet/index?invite_id=${util.getSessionId()}`,
...
const methods = {
    ...
    downImage () {
        ...
        let that = this,
            ...
            pagePath = encodeURIComponent('page/activity/pages/wallet/index'),
    ...
    saveImage () {
        let that = this;
        util2.saveImageToPhotosAlbum({filePath: that.data.tempFilePath}).finally(res => {
            that.data.isDownPage = false;
            if (res.status === 40101) {
